...
const cards = [
  {
    ...
    description: 'Deep understanding of the risks facing apartment buildings, condos, and rental properties. Our specialists know the regulatory landscape and coverage requirements unique to habitational real estate.',
    image: 'https://images.unsplash.com/photo-1545324418-cc1a3fa10c00?auto=format&fit=crop&w=600&q=80',
  },
  {
    title: 'Tailored Coverage Strategies',
    description: 'No two properties are the same. We design coverage programs that align with your building type, tenant profile, amenities, and risk exposure — not a one-size-fits-all policy.',
    image: 'https://images.unsplash.com/photo-1560518883-ce09059eeffa?auto=format&fit=crop&w=600&q=80',
  },
  {
    title: 'Responsive Service & Claims Support',
    description: 'When an incident occurs, every hour matters. Our team provides direct access to experienced claims advocates who understand property-specific challenges and move quickly on your behalf.',
      ...
      <div className="max-w-[68rem] mx-auto px-[60px] max-lg:px-6 max-md:px-4">
        <div ref={headerRef} className="text-center max-w-3xl mx-auto mb-16 fade-in-view">
          ...
          <h2 className="text-brand font-bold leading-[1.3] tracking-tight mb-5" style={{ fontSize: 'clamp(2.2rem, 4vw, 2.6rem)' }}>
            Specialized Protection for Every Property
          </h2>
          <p className="text-brand" style={{ fontSize: '1rem', lineHeight: '1.6' }}>
            We combine deep industry knowledge with a consultative approach to deliver insurance programs that truly protect your investment.
          </p>
        </div>
