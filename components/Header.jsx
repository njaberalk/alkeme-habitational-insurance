...
const coverageItems = [
  ...
  { label: 'Earthquake Coverage', href: '/coverage/earthquake-coverage/' },
  { label: "Builders Risk", href: '/coverage/builders-risk/' },
  { label: 'Environmental Liability', href: '/coverage/environmental-liability/' },
...
const resourceItems = [
  ...
  { label: 'Habitational Insurance Cost', href: '/resources/habitational-insurance-cost/' },
  { label: 'Property Insurance Guide', href: '/resources/property-insurance-guide/' },
  { label: 'Flood Insurance Guide', href: '/resources/flood-insurance-guide/' },
  { label: 'Landlord Liability Guide', href: '/resources/landlord-liability-guide/' },
  { label: 'Insurance Glossary', href: '/resources/habitational-insurance-glossary/' },
  { label: '\u2014 Insights \u2014', href: null, divider: true },
  { label: 'Market Trends 2026', href: '/blog/habitational-insurance-market-trends-2026/' },
  { label: 'Common Mistakes', href: '/blog/common-insurance-mistakes-property-owners/' },
];
...
const industryItems = [
  ...
  { label: 'Mixed-Use Properties', href: '/industries/mixed-use-properties/' },
  { label: 'HOA Insurance', href: '/industries/homeowners-associations/' },
  { label: 'Property Management', href: '/industries/property-management/' },
  { label: 'Single-Family Rentals', href: '/industries/single-family-developments/' },
  { label: 'Affordable Housing', href: '/industries/affordable-housing/' },
...
export default function Header() {
  ...
  const isHome = pathname === '/habitational' || pathname === '/habitational/' || pathname === '/';
        ...
        <div className="lg:hidden bg-stone overflow-hidden" aria-hidden="true" style={{ maxHeight: mobileOpen ? '90vh' : '0', transition: 'max-height 0.4s ease', borderTop: mobileOpen ? '1px solid #e3e3d8' : 'none' }}>
          <div className="px-6 py-6 space-y-1 max-h-[80vh] overflow-y-auto">
            ...
            <div className="border-t border-ash pt-4 mt-4 space-y-3">
              ...
              <Link href="/resources/habitational-insurance-cost/" onClick={() => setMobileOpen(false)} className="block text-brand hover:text-blue-dark uppercase tracking-[0.12em] font-semibold py-2 no-underline" style={{ fontSize: '0.7rem' }}>Habitational Insurance Cost</Link>
              <Link href="/resources/property-insurance-guide/" onClick={() => setMobileOpen(false)} className="block text-brand hover:text-blue-dark uppercase tracking-[0.12em] font-semibold py-2 no-underline" style={{ fontSize: '0.7rem' }}>Property Insurance Guide</Link>
              <Link href="/blog/habitational-insurance-market-trends-2026/" onClick={() => setMobileOpen(false)} className="block text-brand hover:text-blue-dark uppercase tracking-[0.12em] font-semibold py-2 no-underline" style={{ fontSize: '0.7rem' }}>Market Trends 2026</Link>
